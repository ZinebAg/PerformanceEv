...
obs3[3,]<-c(300,1,4,164.727,1063.012,0.984816,0.491840) ##dernière valeur update
...
legend(x = "top", inset=.02,ncol=3,cex=0.6,
       c('1','2','4','8'), fill=c("white", "blue","red","green"), title="number of servers")

max_y <- max( y=obs2[,7],y=obs3[,7])

plot(x=obs1[,1],y=obs2[,7],xlab= "C",ylab= "d", ylim = c(0,max_y))
points(x=obs1[,1],y=obs3[,7],xlab= "C"
       ,ylab= "d",col="red", pch = 10, cex = 0.5)
points(x=obs1[,1],y=obs4[,7],xlab= "C"
       ,ylab= "d",col="green", pch = 10, cex = 0.5)
