...
max_y <- max(y=obs6[,4], y=obs6[,4])
plot(x=obs6[,1],y=obs6[,4],xlab= "C"
     ,ylab= "θ", ylim = c(0,max_y))

max_y <- max(y=obs6[,5], y=obs6[,5])
plot(x=obs6[,1],y=obs6[,5],xlab= "C"
     ,ylab= "θ", ylim = c(0,max_y))

max_y <- max(y=obs6[,6], y=obs6[,6])
plot(x=obs6[,1],y=obs6[,6],xlab= "C"
     ,ylab= "θ", ylim = c(0,max_y))


max_y <- max(y=obs6[,7], y=obs6[,7])
plot(x=obs6[,1],y=obs6[,7],xlab= "C"
     ,ylab= "θ", ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(1:5),4],xlab= "C with fixed 1 server" ,ylab= "θ",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(16:20),4],xlab= "C with fixed 3 servers" ,ylab= "θ",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(31:35),4],xlab= "C with fixed 5 servers" ,ylab= "θ",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(46:50),4],xlab= "C with fixed 7 servers" ,ylab= "θ",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(61:65),4],xlab= "C with fixed 10 servers" ,ylab= "θ",ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(1:5),5],xlab= "C with fixed 1 server" ,ylab= "pps",ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(16:20),5],xlab= "C with fixed 3 servers" ,ylab= "pps",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(31:35),5],xlab= "C with fixed 5 servers" ,ylab= "pps",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(46:50),5],xlab= "C with fixed 7 servers" ,ylab= "pps",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(61:65),5],xlab= "C" ,ylab= "pps",ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(1:5),6],xlab= "C with fixed 1 server" ,ylab= "cps",ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(16:20),6],xlab= "C with fixed 3 servers" ,ylab= "cps",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(31:35),6],xlab= "C with fixed 5 servers" ,ylab= "cps",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(46:50),6],xlab= "C with fixed 7 servers" ,ylab= "cps",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(61:65),6],xlab= "C with fixed 10 servers" ,ylab= "cps",ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(1:5),7],xlab= "C with fixed 1 server" ,ylab= "d",ylim = c(0,max_y))
...
plot(x=obs7[(1:5),1],y=obs7[(16:20),7],xlab= "C with fixed 3 servers" ,ylab= "d",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(31:35),7],xlab= "C with fixed 5 servers" ,ylab= "d",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(46:50),7],xlab= "C with fixed 7 servers" ,ylab= "d",ylim = c(0,max_y))
...
plot(x=obs7[(16:20),1],y=obs7[(61:65),7],xlab= "C with fixed 10 servers" ,ylab= "d",ylim = c(0,max_y))
